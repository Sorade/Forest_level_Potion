...
class Level1(Level):
    ...
    def initialise(self):
        ...
        ins.scroll_map = Item('Map',0,var.background, 0, 0)
    ...
    def execute(self):
        ...
        if self.run == True:
            ...
            ins.scroll_map.offset() #offsets grass background map
            ...
            #blitting        
            var.screen.blit(ins.scroll_map.image, ins.scroll_map.rect) # blits the grass map to new pos
